...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    lazy var persistentContainer: NSPersistentContainer = {
        ...
        let container = NSPersistentContainer(name: "COVIDData")
        ...
        container.viewContext.mergePolicy = NSMergeByPropertyObjectTrumpMergePolicy // this takes source of truth the cloud kit
